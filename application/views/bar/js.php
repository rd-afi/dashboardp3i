<!-- All Jquery -->
    ...
    <!-- Chart.js -->
    <script src="<?php echo base_url('assets/js/lib/chart-js/Chart.min.js') ?>"></script>

    <!-- DataTable -->
    <script src="<?php echo base_url('assets/js/lib/datatables/datatables.min.js') ?>"></script>
    <script src="<?php echo base_url('assets/js/lib/datatables/cdn.datatables.net/jquery.dataTables.min.js') ?>"></script>
