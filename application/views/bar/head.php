                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="<?php echo base_url('assets/images/users/4.png') ?>" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                                                <div class="mail-contnet">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-wpforms"></i><span class="hide-menu">Add Data</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo site_url('datamhs') ?>">Input Data Mahasiswa</a></li>
                                <li><a href="<?php echo site_url('isiqsaurp3i') ?>">Input Data Dosen</a></li>
                                <li><a href="<?php echo site_url('isiqsaurp3i') ?>">Input Data Dosen Tamu</a></li>
                            </ul>
                        </li>
